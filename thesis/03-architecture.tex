...
\lstinputlisting[caption=Query Interface,label=src:query-protos,firstline=10,lastline=24]{../source/sd/proto/connect.proto}
...
\lstinputlisting[caption=Session Interface,label=src:session-protos,firstline=26]{../source/sd/proto/connect.proto}
...
\lstinputlisting[caption=Capability Service Interface,label=src:capability-protos]{../source/sd/proto/capabilities.proto}
