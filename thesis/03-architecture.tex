...
It contains a protocol version, port and the public key of the client.
...
\begin{description}
    ...
    \item[Sign key]\hfill\\
        The signature key of the client. %% TODO: either sign or remove sign key?
\end{description}
...
He will then assemble a response message containing its own version, name, available local services and its public key.
