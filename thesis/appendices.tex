...
\lstinputlisting[firstline=3]{../../source/sd/proto/discovery.proto}

\clearpage
\section{Connection establishment interface}
\label{apx:connection-establishment}

\lstinputlisting[firstline=3]{../../source/sd/proto/encryption.proto}

\clearpage
\section{Service query interface}
\label{apx:service-query}

\lstinputlisting[firstline=14,lastline=27]{../../source/sd/proto/connect.proto}

\clearpage
\section{Session initiation interface}
\label{apx:session-initiation}

\lstinputlisting[firstline=29,lastline=48]{../../source/sd/proto/connect.proto}

\clearpage
\section{Session termination interface}
\label{apx:session-termination}

\lstinputlisting[firstline=49,lastline=52]{../../source/sd/proto/connect.proto}
