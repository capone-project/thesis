    ...
    \begin{figure}
        ...
        \resizebox{0.8\textwidth}{!}
        {
            \begin{sequencediagram}
                ...
                \begin{call}{c}{CreateSession(c, Parameters p)}{s}{c1}
                    \begin{call}{s}{SaveSession(c, c, p)}{s}{Capability c1}
                    \end{call}
                \end{call}

                \postlevel

                \begin{call}{c}{CreateSession(i, c1)}{i}{c2}
                    \begin{call}{i}{SaveSession(c, i, c1)}{i}{Capability c2}
                    \end{call}
                \end{call}
                \postlevel
    ...
    \begin{figure}
        ...
        \resizebox{0.8\textwidth}{!}
        {
            \begin{sequencediagram}
                ...
                \begin{call}{r}{RequestCapability(e, s, params)}{c}{c1}
                    \postlevel
...
\begin{frame}[allowframebreaks]{References}
    ...
    {\tiny \bibliography{../thesis/resources/bibliography}}
\end{frame}
